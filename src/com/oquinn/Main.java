...
class TaskView
{
    ...
    private void add()
    {
        String name = prompt("Enter the new task's name.");
        String description = prompt("Enter the new task's description.");
        int priority = promptInt("Enter the new task's priority");
